        ...
        (
            {
                ...
                "team-player-stats": {"filename": "fox-sports-nba-team-player-stats-{timestamp}"},
                "team-stats": {"filename": "fox-sports-nba-team-stats-{timestamp}"},
                "team-roster": {"filename": "fox-sports-nba-team-roster-{timestamp}"},
                "player-stats": {"filename": "fox-sports-nba-player-stats-{timestamp}"},
                "advanced-player-stats": {"filename": "fox-sports-nba-advanced-player-stats-{timestamp}"},
            },
            "2022-02-16",
            "nba",
        )
